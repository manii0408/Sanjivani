  ...
  return (
    <div className="min-h-screen px-4 py-12 bg-gray-100 dark:bg-gray-900 text-gray-800 dark:text-white">
      <div className="max-w-md mx-auto bg-white/10 dark:bg-gray-800 p-6 rounded-lg shadow-md">
        <h2 className="text-2xl font-bold mb-4 text-red-600 text-center">Register as Organ Donor</h2>
        <form className="space-y-4">
          ...
          <select className="w-full p-2 rounded border dark:bg-gray-700 dark:text-white">
            <option>Select Organ(s) to Donate</option>
